...
<div id="header">
    ...
    <main>
        ...
        <div class="fondotablas">
            ...
            <?php
            $sql="SELECT * FROM Camaras where precio < 5000;";
        ...
        <div class="fondotablas">
            <table border="1">
                        <h1>Discos</h1>
                            ...
                            <?php
                            $sql="SELECT * FROM discos where precio < 20000;";
        ...
        <div class="fondotablas">
            ...
            <h1>Fuentes</h1>
                ...
                <?php
                $sql="SELECT * FROM fuentes_de_poder where precio < 100000;";
        ...
        <div class="fondotablas">
            ...
            <h1>Gabinete</h1>
                ...
                <?php
                $sql="SELECT * FROM gabinetes where precio < 50000;";
        ...
        <div class="fondotablas">
            ...
            <h1>joysticks</h1>
                ...
                <?php
                $sql="SELECT * FROM joysticks where precio < 30000;";
        ...
        <div class="fondotablas">
            ...
            <h1>Memorias Ram</h1>
                ...
                <?php
                $sql="SELECT * FROM modulos_ram where precio < 30000;";
        ...
        <div class="fondotablas">
            ...
            <h1>Monitores</h1>
                ...
                <?php
                $sql="SELECT * FROM monitores where precio < 100000;";
        ...
        <div class="fondotablas">
            ...
            <h1>Mothers</h1>
                ...
                <?php
                $sql="SELECT * FROM mothers where precio < 50000;";
        ...
        <div class="fondotablas">
            ...
            <h1>Mouses</h1>
                ...
                <?php
                $sql="SELECT * FROM mouse where precio < 10000;";
        ...
        <div class="fondotablas">
            ...
            <h1>procesadores</h1>
                ...
                <?php
                $sql="SELECT * FROM procesadores where precio < 50000;";
        ...
        <div class="fondotablas">
            ...
            <h1>Targetas Graficas</h1>
                ...
                <?php
                $sql="SELECT * FROM targetas_graficas where precio < 100000;";
        ...
        <div class="fondotablas">
            ...
            <h1>teclados</h1>
                ...
                <?php
                $sql="SELECT * FROM teclados where precio < 10000;";
