...
<div id="header">
    ...
    <main>
        ...
        <div class="fondotablas">
            ...
            <?php
            $sql="SELECT * FROM Camaras where marca in ('Redragon','logitech');";
        ...
        <div class="fondotablas">
            <table border="1">
                        <h1>Discos</h1>
                            ...
                            <?php
                            $sql="SELECT * FROM discos where marca in ('Kingston');";
        ...
        <div class="fondotablas">
            ...
            <h1>Fuentes</h1>
                ...
                <?php
                $sql="SELECT * FROM fuentes_de_poder where Marca='Be_Quiet';";
        ...
        <div class="fondotablas">
            ...
            <h1>Gabinete</h1>
                ...
                <?php
                $sql="SELECT * FROM gabinetes where marca in ('Deepcool','Lian Li');";
        ...
        <div class="fondotablas">
            ...
            <h1>joysticks</h1>
                ...
                <?php
                $sql="SELECT * FROM joysticks where marca in ('Sony');";
        ...
        <div class="fondotablas">
            ...
            <h1>Memorias Ram</h1>
                ...
                <?php
                $sql="SELECT * FROM modulos_ram where marca in ('Hp');";
        ...
        <div class="fondotablas">
            ...
            <h1>Monitores</h1>
                ...
                <?php
                $sql="SELECT * FROM monitores where marca in ('LG');";
        ...
        <div class="fondotablas">
            ...
            <h1>Mothers</h1>
                ...
                <?php
                $sql="SELECT * FROM mothers where marca in ('Asrock');";
        ...
        <div class="fondotablas">
            ...
            <h1>Mouses</h1>
                ...
                <?php
                $sql="SELECT * FROM mouse where marca in ('Redragon');";
        ...
        <div class="fondotablas">
            ...
            <h1>procesadores</h1>
                ...
                <?php
                $sql="SELECT * FROM procesadores where marca in ('Intel');";
        ...
        <div class="fondotablas">
            ...
            <h1>Targetas Graficas</h1>
                ...
                <?php
                $sql="SELECT * FROM targetas_graficas where marca in ('GeForce','Asrock');";
        ...
        <div class="fondotablas">
            ...
            <h1>teclados</h1>
                ...
                <?php
                $sql="SELECT * FROM teclados where marca in ('Logitech');";
